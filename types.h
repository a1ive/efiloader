...
typedef struct _BL_FIRMWARE_PROCESSOR_STATE_ARM64
{
	UINT64 Sctlr;
	UINT64 Vbar;
	UINT64 Reserved10;
	...
	UINT64 Tcr;
	UINT64 Mair;
	UINT32 InterruptsEnabled;
	UINT32 Reserved54;
} BL_FIRMWARE_PROCESSOR_STATE_ARM64;
...
#define BL_FIRMWARE_DESCRIPTOR_X64_V2_SIZE 0x46
#define BL_FIRMWARE_DESCRIPTOR_X64_V3_SIZE 0x48
...
typedef struct _BL_FIRMWARE_DESCRIPTOR_ARM64
{
	UINT32 Version;
	UINT32 Unknown;
	EFI_HANDLE ImageHandle;
	EFI_SYSTEM_TABLE* SystemTable;
	BL_FIRMWARE_PROCESSOR_STATE_ARM64 ProcessorState;
} BL_FIRMWARE_DESCRIPTOR_ARM64;

#define BL_FIRMWARE_DESCRIPTOR_ARM64_SIZE 0x70
...
C_ASSERT(BL_FIRMWARE_DESCRIPTOR_X64_V2_SIZE == FIELD_OFFSET(BL_FIRMWARE_DESCRIPTOR_X64, ProcessorState.TranslationEnabled));
C_ASSERT(sizeof(BL_FIRMWARE_DESCRIPTOR_X64) == BL_FIRMWARE_DESCRIPTOR_X64_V3_SIZE);
...
C_ASSERT(FIELD_OFFSET(BL_FIRMWARE_DESCRIPTOR_ARM64, ImageHandle) == 0x08);
C_ASSERT(FIELD_OFFSET(BL_FIRMWARE_DESCRIPTOR_ARM64, SystemTable) == 0x10);
C_ASSERT(FIELD_OFFSET(BL_FIRMWARE_DESCRIPTOR_ARM64, ProcessorState) == 0x18);
C_ASSERT(FIELD_OFFSET(BL_FIRMWARE_DESCRIPTOR_ARM64, ProcessorState.Sctlr) == 0x18);
C_ASSERT(FIELD_OFFSET(BL_FIRMWARE_DESCRIPTOR_ARM64, ProcessorState.Tpidr) == 0x38);
C_ASSERT(FIELD_OFFSET(BL_FIRMWARE_DESCRIPTOR_ARM64, ProcessorState.CurrentEl) == 0x40);
C_ASSERT(FIELD_OFFSET(BL_FIRMWARE_DESCRIPTOR_ARM64, ProcessorState.Ttbr0) == 0x48);
C_ASSERT(FIELD_OFFSET(BL_FIRMWARE_DESCRIPTOR_ARM64, ProcessorState.Ttbr1) == 0x50);
C_ASSERT(FIELD_OFFSET(BL_FIRMWARE_DESCRIPTOR_ARM64, ProcessorState.Tcr) == 0x58);
C_ASSERT(FIELD_OFFSET(BL_FIRMWARE_DESCRIPTOR_ARM64, ProcessorState.Mair) == 0x60);
C_ASSERT(FIELD_OFFSET(BL_FIRMWARE_DESCRIPTOR_ARM64, ProcessorState.InterruptsEnabled) == 0x68);
C_ASSERT(sizeof(BL_FIRMWARE_PROCESSOR_STATE_ARM64) == 0x58);
C_ASSERT(sizeof(BL_FIRMWARE_DESCRIPTOR_ARM64) == BL_FIRMWARE_DESCRIPTOR_ARM64_SIZE);
typedef BL_FIRMWARE_PROCESSOR_STATE_ARM64 BL_FIRMWARE_PROCESSOR_STATE;
typedef BL_FIRMWARE_DESCRIPTOR_ARM64 BL_FIRMWARE_DESCRIPTOR;
#endif
